...
public class LoadSavedInstallationCmd extends AATCommand implements CommandExecutionCallback {

    public LoadSavedInstallationCmd() {
        super();
        super.cmd = Command.GET_SAVED_INST;
    }
