...
public class PrimaryConfigurationCmd extends AATTest implements CommandExecutionCallback {

    public PrimaryConfigurationCmd() {
        super();
        super.cmd = Command.PRIM_CONN_CONF;
    }
