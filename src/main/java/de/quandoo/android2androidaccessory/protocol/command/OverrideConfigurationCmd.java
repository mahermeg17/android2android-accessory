...
public class OverrideConfigurationCmd extends AATCommand implements CommandExecutionCallback {

    public OverrideConfigurationCmd() {
        super();
        super.cmd = Command.OVERRIDE_CONF;
    }
